...
/**
 * Test helpers for the randomdata question type.
 *
 * @package    qtype
...
global $CFG;
require_once($CFG->dirroot . '/question/type/randomdata/question.php');
...
/**
 * Test helper class for the randomdata question type.
 *
 * @copyright  2022 Nicole Brito nicole.brito@correo.unimet.edu.ve, Giselle Ferreira giselle.ferreira@correo.unimet.edu.ve
 * @copyright  Based on work 2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_randomdata_test_helper extends question_test_helper {
     ...
     */
    public function make_randomdata_question_sum() {
        question_bank::load_question_definition_classes('calculated');
        $q = new qtype_randomdata_question();
        ...
        $q->qtype = question_bank::get_qtype('randomdata');
        ...
        $q->datasetloader = new qtype_randomdata_test_dataset_loader(0, array(
            array('a' => 1, 'b' => 5),
            array('a' => 3, 'b' => 4),
            array('a' => 3, 'b' => 0.01416),
    ...
    /**
     * Makes a randomdata question about summing two numbers.
     * @return qtype_calculated_question
     */
    public function get_randomdata_question_data_sum() {
        question_bank::load_question_definition_classes('randomdata');
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'randomdata';
        ...
        $qdata->options->answers = array(
            ...
            14 => new qtype_numerical_answer(14, '{a} - {b}', 0.0, 'Add. not subtract!.', FORMAT_HTML, 0.001),
            17 => new qtype_numerical_answer(17, '*', 0.0, 'Completely wrong.', FORMAT_HTML, 0),
        );
     ...
     * @return qtype_calculated_question
     */
    public function get_randomdata_question_form_data_sum() {
        question_bank::load_question_definition_classes('randomdata');
...
/**
 * Test implementation of {@link qtype_randomdata_dataset_loader}. Gets the values
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_randomdata_test_dataset_loader extends qtype_randomdata_dataset_loader{
    protected $valuesets;

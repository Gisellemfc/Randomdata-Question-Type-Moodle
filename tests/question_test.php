...
/**
 * Unit tests for the randomdata question definition class.
 *
...
/**
 * Unit tests for qtype_randomdata_definition.
 *
 * @copyright  2022 Nicole Brito nicole.brito@correo.unimet.edu.ve, Giselle Ferreira giselle.ferreira@correo.unimet.edu.ve
 * @copyright  Based on work 2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_randomdata_question_test extends advanced_testcase {


    public function test_is_complete_response() {
        $question = test_question_maker::make_question('randomdata');
    ...
    public function test_grading() {
        ...
        $this->assertEquals(array(0, question_state::$gradedwrong), $question->grade_response(array('answer' => $values['a'] - $values['b'])));
        $this->assertEquals(array(1, question_state::$gradedright), $question->grade_response(array('answer' => $values['a'] + $values['b'])));
    }
    ...
    public function test_get_correct_response() {
        ...
        $this->assertSame(array('answer' => '6.0' ), $question->get_correct_response());

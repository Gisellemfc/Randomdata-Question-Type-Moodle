...
/**
 * Unit tests for qtype_randomdata_variable_substituter.
 *
...
/**
 * Unit tests for {@link qtype_randomdata_variable_substituter}.
 *
 * @copyright  2022 Nicole Brito nicole.brito@correo.unimet.edu.ve, Giselle Ferreira giselle.ferreira@correo.unimet.edu.ve
 * @copyright  Based on work 2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_randomdata_variable_substituter_test extends advanced_testcase {

    
    public function test_simple_expression() {
        $vs = new qtype_randomdata_variable_substituter(array('a' => 1, 'b' => 2), '.');
    ...
    public function test_cannot_use_nonnumbers() {
        ...
        $vs = new qtype_randomdata_variable_substituter(array('a' => 'frog', 'b' => -2), '.');
    }
    ...
    public function test_division_by_zero_expression() {
        ...
        $vs = new qtype_randomdata_variable_substituter(array('a' => 1, 'b' => 0), '.');
        $this->expectException(moodle_exception::class);
        $vs->calculate('{a} / {b}');
    }
    ...
    public function test_expression_has_unmapped_placeholder() {
        ...
        $this->expectExceptionMessage(get_string('illegalformulasyntax', 'qtype_randomdata', '{c}'));
        $vs = new qtype_randomdata_variable_substituter(array('a' => 1, 'b' => 2), '.');
        $vs->calculate('{c} - {a} + {b}');
    }
    ...
    public function test_replace_expressions_in_text_commas_for_decimals() {
        $vs = new qtype_randomdata_variable_substituter(

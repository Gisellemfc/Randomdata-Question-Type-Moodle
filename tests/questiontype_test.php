...
/**
 * Unit tests for (some of) question/type/randomdata/questiontype.php.
 *
 ...
 * @copyright  Based on work 2012 The Open University
...
require_once($CFG->dirroot . '/question/type/randomdata/tests/helper.php');


class qtype_randomdata_test extends advanced_testcase {

    
    public static $includecoverage = array(
        'question/type/questiontypebase.php',
        'question/type/randomdata/questiontype.php'
    );
    ...
    protected function setUp(): void {
        $this->qtype = new qtype_randomdata();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'randomdata');
    }
    ...
    public function test_get_random_guess_score() {
        $q = test_question_maker::get_question_data('randomdata');
    ...
    public function test_load_question() {
        ...
        $fromform = test_question_maker::get_question_form_data('randomdata');
        $fromform->category = $category->id . ',' . $syscontext->id;

        $question = new stdClass();
        $question->category = $category->id;
        $question->qtype = 'randomdata';
        ...
        $this->assertEquals('randomdata', $questiondata->qtype);
    ...
    protected function get_possible_response($ans, $tolerance, $type) {
        ...
        return get_string('answerwithtolerance', 'qtype_randomdata', $a);
    }
    ...
    public function test_placehodler_regex() {
        preg_match_all(qtype_randomdata::PLACEHODLER_REGEX, '= {={a} + {b}}', $matches);
        $this->assertEquals([['{a}', '{b}'], ['a', 'b']], $matches);
    }

    public function test_formulas_in_text_regex() {
        preg_match_all(qtype_randomdata::FORMULAS_IN_TEXT_REGEX, '= {={a} + {b}}', $matches);
        $this->assertEquals([['{={a} + {b}}'], ['{a} + {b}']], $matches);
    }
